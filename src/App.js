    ...
    <Router>
      <div style={{display: "flex", flex: "1", flexDirection: "column", alignItems: "center", width: "100vw", height: "100vh"}}>
        <div style={{marginBottom: "30px"}}>
          ...
          <h3 style={{marginTop: 0, color: "grey"}}>Your number one source for Big Chungus.</h3>
          <nav>
...
const Images =_=> {
  return (
    <div style={{display: "flex", flex: "1", flexDirection: "column", alignItems: "center"}}>
      <button onClick={() => {if(window.confirm("Are you sure? You are leaving BigChungus420.com to go to google.com. BigChungus420.com cannot guarantee that this link is safe.")) { window.open("https://www.google.com/search?q=big+chungus&tbm=isch", "_blank").focus(); }}}>More Chungus</button>
